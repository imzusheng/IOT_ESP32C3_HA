...
- 若有差异以 README.md 为准
- 所有代码文件使用UTF-8编码，中文注释和文档
- 硬件限制：ESP32-C3只有264KB SRAM，2个硬件定时器，必须时刻注意资源使用
...
### 13. Home Assistant集成 (HomeAssistantHelper) - `app/ha.py`
- **功能**: Home Assistant设备发现和状态上报
- **特性**: 
  - 自动设备发现配置
  - 温湿度传感器状态上报
  - 设备可用性管理
...
- **传感器**: 支持SHT40温湿度传感器，MCU内部温度监控
- **通信**: WiFi、MQTT、BLE多种通信方式